                            ...
                            <div class="scrollbar-sidebar">
                                 <div class="app-sidebar__inner">
                                    <ul class="vertical-nav-menu">
                                        ...
                                        <li>
                                            <a href="{{route('kegiatanislam')}}" class="mm-active">
                                                <i class="metismenu-icon pe-7s-display2"></i>
                                                    Kegiatan Islam
                                            </a>
                                        </li>
                                            ...
                                            @php $no = 0 @endphp
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <button type="button" id="PopoverCustomT-1" class="btn btn-primary " data-toggle="modal" data-target="#updatekegiatanislam"><i class="fa fa-edit"> Edit </i></button>
