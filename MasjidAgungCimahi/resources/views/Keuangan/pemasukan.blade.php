                            ...
                            <div class="scrollbar-sidebar">
                                 <div class="app-sidebar__inner">
                                    <ul class="vertical-nav-menu">
                                        ...
                                        <li>
                                            <a href="{{route('kajian')}}" class="mm-active">
                                        ...
                                        <li class="mm-active">
                                            ...
                                            <ul  class="mm-show"> 
                                                <li>
                                                    <a href="{{route('keuangan.pemasukan')}}" class="mm-active">
                                            ...
                                            @php $no = 0 @endphp
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <button type="button" id="PopoverCustomT-1" class="btn btn-primary " data-toggle="modal" data-target="#updatepemasukan"><i class="fa fa-edit"> Edit </i></button>
                    ...
                    <label for="">Judul Pemasukan</label>
                        <input type="text" id="nama" name="judul" class="form-control">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="nama" name="jenis_keuangan" class="form-control">
                             </div>
                            <br>
