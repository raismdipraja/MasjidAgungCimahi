                                    ...
                                    <ul class="vertical-nav-menu">
                                        ...
                                        <li class="mm-active">
                                            ...
                                            <ul  class="mm-show"> 
                                                ...
                                                <li>
                                                    <a href="{{route('keuangan.pengeluaran')}}" class="mm-active">
                                            ...
                                            @php $no = 0 @endphp
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <button type="button" id="PopoverCustomT-1" class="btn btn-primary "  data-toggle="modal" data-target="#updatepengeluaran"><i class="fa fa-edit"> Edit </i></button>
                    ...
                    <div class="form-group">           
                        ...
                        <input type="text" id="nama" name="jatuh_tempo" class="form-control">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" id="nama" name="jatuh_tempo" class="form-control">
                             </div>
                            <br>
